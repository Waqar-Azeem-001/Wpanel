...
EVENTS = _events(
    ...
    Event("cancellation.completed", "A domain cancellation was completed", C.SERVICES, "cancellation_completed",
          essential=True),
    Event("affiliate.approved", "Your affiliate application was approved", C.SERVICES, "affiliate_approved",
          essential=True),
    Event("affiliate.rejected", "Your affiliate application was not accepted", C.SERVICES, "affiliate_rejected",
          essential=True),
    Event("commission.approved", "An affiliate commission was approved", C.SERVICES, "commission_approved"),
    Event("payout.paid", "An affiliate payout was recorded", C.SERVICES, "payout_paid", essential=True),
    ...
    Event("affiliate.applied", "Someone applied to join the affiliate programme", C.TEAM, default_email=False),
    Event("commission.refund_after_payout", "An invoice was refunded after its commission was paid out", C.TEAM,
          default_email=False),
